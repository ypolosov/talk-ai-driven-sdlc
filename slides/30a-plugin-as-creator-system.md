...
<tr v-click><td><b>Rules</b></td><td>Локализованные нормы метода, привязанные к подсистемам</td></tr>
<tr v-click><td><b>Skill</b></td><td>Метод работы, навык, мастерство (теория или алгоритм)</td></tr>
